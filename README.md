...
<blockquote> <em>Fig. 5 - screenshot of the File widget grid window where the feature role was applied to Nemerow_Index and the target role to WQI.</em></blockquote>
...
<blockquote> <em>Fig.6 - snapshot of the Linear Regression properties dialog showing the model coefficients and intercepts calculated by Orange.</em></blockquote>
<br>
...
<br>
<blockquote> <em>Fig.7 - generated scatter plot graph displaying the downward-sloping regression trend line passing smoothly through the 150 data points.</em></blockquote>
<br>
...
<blockquote> <em>Fig.8 - close-up crop of the Scatter Plot’s bottom-right label showing the -0.98 statistical validation metric.</em></blockquote>
